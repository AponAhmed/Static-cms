...
let uploadTriger = document.getElementById('uploadTriger');
let uploader;
if (uploadTriger) {
    uploader = new ImageUploader(AJAXURL + 'contacts/');
    uploadTriger.addEventListener('change', (e) => {
...
class WriteUs {
    ...
    handleSubmit(event) {
        ...
        var data = formData;
        jQuery.post(AJAXURL + "contacts/send/", data, (response) => {
...
function contactForm_init() {
    ...
    jQuery("#contactForm").submit(function (e) {
        ...
        jQuery.post(AJAXURL + "contacts/send/", data, function (response) {
            jQuery(".spinLoader").remove();
            var obj = JSON.parse(response);
            if (obj.error === false) {
